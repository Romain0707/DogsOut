 ...
 */
final class Version20260404164907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_group ADD conversation_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8F02BF9D9AC0396 ON user_group (conversation_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8F02BF9D9AC0396 ON user_group');
        $this->addSql('ALTER TABLE user_group DROP conversation_id');
    }
}
