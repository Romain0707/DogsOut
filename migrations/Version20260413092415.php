 ...
 */
final class Version20260413092415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE balade_rating (id INT AUTO_INCREMENT NOT NULL, rating INT NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, balade_id INT NOT NULL, INDEX IDX_939502E9A76ED395 (user_id), INDEX IDX_939502E9FE292D59 (balade_id), UNIQUE INDEX unique_rating (balade_id, user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE balade_rating ADD CONSTRAINT FK_939502E9A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE balade_rating ADD CONSTRAINT FK_939502E9FE292D59 FOREIGN KEY (balade_id) REFERENCES balade (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balade_rating DROP FOREIGN KEY FK_939502E9A76ED395');
        $this->addSql('ALTER TABLE balade_rating DROP FOREIGN KEY FK_939502E9FE292D59');
        $this->addSql('DROP TABLE balade_rating');
