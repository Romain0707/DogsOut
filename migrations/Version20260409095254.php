 ...
 */
final class Version20260409095254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balade DROP snapshot_path');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE balade ADD snapshot_path VARCHAR(255) DEFAULT NULL');
