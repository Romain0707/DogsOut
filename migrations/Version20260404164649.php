 ...
 */
final class Version20260404164649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_event (id INT AUTO_INCREMENT NOT NULL, event_date DATETIME NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, usergroup_id INT NOT NULL, balade_id INT NOT NULL, proposed_by_id INT NOT NULL, INDEX IDX_6B8221C0D2112630 (usergroup_id), INDEX IDX_6B8221C0FE292D59 (balade_id), INDEX IDX_6B8221C0DAB5A938 (proposed_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE group_event_response (id INT AUTO_INCREMENT NOT NULL, availability VARCHAR(20) NOT NULL, responded_at DATETIME NOT NULL, group_event_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_E01A2B5978C7A4F4 (group_event_id), INDEX IDX_E01A2B59A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE group_member (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL, joined_at DATETIME DEFAULT NULL, usergroup_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_A36222A8D2112630 (usergroup_id), INDEX IDX_A36222A8A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_group (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, is_public TINYINT NOT NULL, created_at DATETIME NOT NULL, created_by_id INT NOT NULL, INDEX IDX_8F02BF9DB03A8386 (created_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE group_event_response');
