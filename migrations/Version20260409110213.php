 ...
 */
final class Version20260409110213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE balade_image (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(255) DEFAULT NULL, position SMALLINT DEFAULT 0 NOT NULL, updated_at DATETIME DEFAULT NULL, balade_id INT NOT NULL, INDEX IDX_DDCD887AFE292D59 (balade_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE balade_image ADD CONSTRAINT FK_DDCD887AFE292D59 FOREIGN KEY (balade_id) REFERENCES balade (id)');
        $this->addSql('ALTER TABLE balade ADD difficulty VARCHAR(20) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE balade_image');
        $this->addSql('ALTER TABLE balade DROP FOREIGN KEY FK_540083D7A76ED395');
        $this->addSql('ALTER TABLE balade DROP difficulty');
